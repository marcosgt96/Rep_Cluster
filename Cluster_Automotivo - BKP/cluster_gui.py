...
class RPMGauge(Canvas):
    ...
    def draw_gauge(self):
        ...
        for i in range(num_marks):
            ...
            # Cor: vermelho para zona vermelha (6-7)
    ...
    def set_value(self, value, gear_change=False):
        ...
        angle = percentage * 270 + 150 # De 0° a 270°
        rad = math.radians(angle)
...
class SpeedGauge(Canvas):
    ...
    def draw_gauge(self):
        ...
        # Desenhar marcas e números (0-240, de 20 em 20)
        for i in range(13):  # 0, 20, 40, ..., 240
            speed = i * 20
            # 0 na esquerda (0°), 270 + 150
            angle = (speed / 240) * 270 + 150  # 0 a 270 graus
            rad = math.radians(angle)
...
class HorizontalGauge(Frame):
    ...
    def __init__(self, parent, label="", unit="", min_val=0, max_val=100, **kwargs):
        ...
        top_frame.pack(fill='x', padx=3, pady=2)
...
class ClusterDisplay(tk.Tk):
    ...
    def _create_widgets(self):
        ...
        indicators_data = [
            ...
            ("TEMP. TRANS.", "°C", 40, 120, 3),
            ("BATERIA", "V", 10, 16, 4),
        ]
        
        self.indicators = {}
        
        # Layout: 3 colunas para 5 indicadores (3 na linha 0, 2 na linha 1)
        ...
        # Configurar 3 colunas
        for c in range(3):
            indicators_frame.grid_columnconfigure(c, weight=1)
        # Configurar 2 linhas
        indicators_frame.grid_rowconfigure(0, weight=1)
        indicators_frame.grid_rowconfigure(1, weight=1)
    ...
    def _update_display(self):
        ...
        self.indicators["TEMP. TRANS."].set_value(data.transmission_oil_temp)
